...
const CreateSeller = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      const response = await axios.post(`https://hire-been.vercel.app/createUser/seller`, ({
        "name": values.name,
        "email": values.email,
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md p-8 space-y-6 bg-white shadow-md rounded-lg">
        <h2 className="text-2xl font-bold text-center text-gray-800">Create Seller</h2>
        <Formik
